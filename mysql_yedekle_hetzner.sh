...
yedek_sunucu_yuklenecek_yer="" # hetzner storage box da bir klasore yukleyecekseniz baslangic kisminda / kullanmayin.
...
echo ">>>>> Yedekleme aktif edilmedigi icin ayri bir sunucuya gonderilmedi."
	...
	sshpass -p $yedek_sunucu_sifresi rsync --progress -e 'ssh -p23' --recursive $mysql_ana_yedek_klasoru $yedek_sunucu_kullanici@$yedek_sunucu_ip:$yedek_sunucu_yuklenecek_yer
